...
namespace Webhook.Utils
{
    public class RollingLogger
    {
        readonly static string LOG_FILE = Path.GetTempPath() + "ec_cpaas_webhook.log";
        ...
        static RollingLogger()
        {
            ...
            Debug.WriteLine("Engagement Cloud CPaaS webhook logging path: " + LOG_FILE);
        }
