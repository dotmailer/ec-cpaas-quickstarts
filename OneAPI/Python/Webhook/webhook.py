# -*- coding: utf-8 -*-
# A basic website to demonstrate receiving data from Engagement Cloud CPaaS using Python and Flask.
import os
import hmac
import hashlib
import json
...
def post_index():
    # Process data sent from Engagement Cloud CPaaS
    try:
        # Grab the body data
...
my_port = int(os.environ.get('PORT', 3000))
